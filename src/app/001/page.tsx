    ...
    return (
        <div className="flex flex-wrap lg:min-h-screen px-6 pb-6 lg:p-6">
            <div className="relative basis-full lg:basis-1/2 pb-52 transition-all ease-in-out duration-300 delay-100">
                <nav className="flex gap-12 py-6 lg:pt-0 lg:pb-4">
                    <img src={`${process.env.NEXT_PUBLIC_LINK_PREFIX}/001/search-icon.svg`} alt="search-icon" className="cursor-pointer" />
                    <span className="cursor-pointer">Explore</span>
                    <span className="cursor-pointer">Stories</span>
                </nav>
                <div className="lg:px-16 pt-6 lg:pt-16 lg:ml-1 transition-all ease-in-out duration-300 delay-100">
            ...
            <div className="basis-full lg:basis-1/2 rounded-2xl lg:rounded-[32px] flex flex-wrap overflow-clip cursor-pointer transition-all ease-in-out duration-300 delay-100">
                <div
